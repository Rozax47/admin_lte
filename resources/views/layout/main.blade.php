...
<body class="hold-transition sidebar-mini">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
          ...
          <a href="{{ asset('template/') }}/index3.html" class="brand-link">
            ...
            <span class="brand-text font-weight-light">Sepuh Library</span>
          </a>
          ...
          <section class="content">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Sepuh Notification</h3>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2023-3000 <a href="https://adminlte.io">Sepuh</a>.</strong> All rights reserved.
      </footer>
